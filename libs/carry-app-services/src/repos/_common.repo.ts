...
import { IMyModel, MyModelStatic, MyModelStaticGeneric } from '../interfaces/carry.interface';
import { UserNotificationsLastOpened } from '../models/carry.model';
import { convertModels, convertModel, convertModelCurry } from '../utils/helpers.utils';
import { UserNotificationsLastOpenedEntity } from '../entities/carry.entity';
